...
export const metadata: Metadata = {
  ...
  description:
    "Expert articles on home nursing, post-operative care, elder care, ICU home setup, and patient recovery. Evidence-based health resources by Maasewa Healthcare clinicians.",
  keywords: [
    "home nursing tips",
  ...
  openGraph: {
    url: `${BASE_URL}/blog`,
    title: "Home Nursing Blog — Recovery Guides & Health Tips | Maasewa Healthcare",
    description:
...
const blogSchema = {
  ...
  "@type": "Blog",
  name: "Maasewa Healthcare Health Blog",
  description:
  ...
  blogPost: [
    {
      ...
      author: { "@type": "Organization", name: "Maasewa Healthcare" },
